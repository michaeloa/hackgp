...
import no.met.precipitationDetection.tiny_gp;
...
public class tiny_gp {
	...
	static final int MAX_LEN = 10000, POPSIZE = 100000, DEPTH = 5, GENERATIONS = 100, TSIZE = 2;
	...
	void evolve() {
		...
		for (gen = 1; gen < GENERATIONS; gen++) {
			if (fbestpop > -1e-5) {
				...
				System.out.print("Input, datacreation, computation & output completeded in " + elapsedTimeNano / 1000000
						+ " milliseconds.");
				System.exit(0);
			}
